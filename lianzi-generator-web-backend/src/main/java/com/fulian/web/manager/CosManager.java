...
public class CosManager {
    ...
    public DeleteObjectsResult deleteObjects(List<String> keyList) throws MultiObjectDeleteException, CosClientException, CosServiceException {
        DeleteObjectsRequest deleteObjectRequest = new DeleteObjectsRequest(cosClientConfig.getBucket());
        // 设置要删除的key列表，最多删除1000个
        ...
        DeleteObjectsResult deleteObjectsResult = cosClient.deleteObjects(deleteObjectRequest);
